...
namespace ATV_Allowance.Services
{
    ...
    public class ReportService : IReportService
    {
        ...
        private void FillDataIntoWorksheetTTNM(Worksheet worksheet, DateTime startDate, DateTime endDate, int role, int price, ref double totalPoint)
        {
            ...
            //border
            worksheet.Range[worksheet.Cells[4, TTNM_COL.STT], worksheet.Cells[currentRow, TTNM_COL.THANHTIEN + 1]].Borders.LineStyle = XlLineStyle.xlContinuous;
            ...
            else
            {
                ...
                //fill value
                worksheet.Cells[currentRow + 2, TTNM_COL.SL_TIN].Value = (totalPoint * price).ToString("n0");
                worksheet.Cells[currentRow + 3, TTNM_COL.SL_TIN].Value = (totalPoint * price).ToString("n0");
                worksheet.Cells[currentRow + 4, TTNM_COL.SL_TIN].Value = (totalPoint * price).ToString("n0");
